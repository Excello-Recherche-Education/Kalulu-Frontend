...
func _set_lesson_number(value: int) -> void:
	...
	look_and_learn_option_button.select(unlocks[lesson_number]["look_and_learn"])
	exercise_option_button_1.select(unlocks[lesson_number]["games"][0])
	exercise_option_button_2.select(unlocks[lesson_number]["games"][1])
	exercise_option_button_3.select(unlocks[lesson_number]["games"][2])
