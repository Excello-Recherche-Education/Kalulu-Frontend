...
static func _get_garden_dimensions(_garden_color_index: int, _garden_image: Image = null) -> Vector2:
	return Vector2(GARDEN_SIZE, GARDEN_CENTER_Y * 2.0)
